        ...
        <div className=' py-24 px-small-screen lg:px-tab-screen xl:px-screen-content  flex flex-col gap-20'>
            ...
            <div className=' photo-text-combination-container'>
                  <div className=' lg:flex-1'>
                   ...
                   <div className='lg:flex-1 flex flex-col gap-10'>
                        ...
                        <h2 className=' text-gray-900 font-semibold text-3xl  semi-md:text-4xl'>About Lemosys Infotech</h2>
            ...
            <div className=' photo-text-combination-container '>
                  <div className=' semi-md:flex-1 flex gap-5'>
                   ...
                   <div className='flex-1 flex flex-col gap-10'>
                        <h2 className=' text-gray-900 font-semibold text-3xl  semi-md:text-4xl'>Lemosys Infotech is also involved in the campaign of social activities</h2>
            ...
            <div className=' photo-text-combination-container '>
                  <div className=' lg:flex-1 lg:flex gap-5'>
                   ...
                   <div className='flex-1 flex flex-col gap-10'>
                        <h2 className=' text-gray-900 font-semibold text-3xl  semi-md:text-4xl'>Our Secret Of Success</h2>
