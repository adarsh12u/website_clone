    ...
    <div className=" h-[90vh]  bg-front_color flex justify-center items-center  flex-col gap-5  ">
      <div className=" w-w-60% xl:w-w-50% flex  gap-20 flex-col ">
        <div className=" flex flex-col gap-10">
          <div>
            <h1 className=" text-3xl md:text-6xl  semi-md:text-7xl   text-white text-center font-semibold">
              Lets Talk!
            </h1>
          ...
          <p className=" text-center text-xl md:text-2xl font-semibold text-white">
            Are you looking to build a Custom Web or Mobile App for your
            business? Let us develop it for you.
          </p>
        ...
        <div>
          <p className=" text-center text-xl text-white font-medium">
            Our expertise has been recognized by all. Work with Lemosys, and
            we’ll do our part to make your project worthy of high praise, too.
          </p>
        </div>
      </div>
      <div className=" mt-10">
