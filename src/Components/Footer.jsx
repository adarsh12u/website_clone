    ...
    <footer className='  bg-gray-900 pt-10  '>
      ...
      <div className=' w-screen  px-footer-content   mb-20 mt-20  footer:flex footer:flex-row footer:justify-between flex flex-col gap-12 md:grid md:grid-cols-2 '>
        ...
        <div className=' footer:w-w-20%'> 
          ...
          <div>
            <p className=' mt-5 text-white text-lg'>Head Office: Plot 169, Scheme 78,
              Part II, Behind Kanak Hospital
              Indore, M.P. India 452010</p>
          </div>
          ...
          <div className=' mt-5 flex flex-col gap-2'>

            {
              cardData.map((data, index) => {
                return <p key={index} className=' text-lg text-white'>{data.content}</p>
              })
            }
          </div>
        ...
        <div className=' footer:w-w-20%'>
          ...
          <div className='  w-width_underline h-1 bg-blue-900'></div>
          <div className='  mt-5'>
            <p className='text-lg text-white'>Stay updated with the latest technology trends and topics with us.</p>
            <div className=' mt-6'>

              <label htmlFor="message" className=' text-white font-semibold'> Email: </label>
              <input type="text" name='message' placeholder=' Email Address' className=' bg-transparent border-b-2 border-white' />
            </div>
          </div>
        </div>
      </div>
